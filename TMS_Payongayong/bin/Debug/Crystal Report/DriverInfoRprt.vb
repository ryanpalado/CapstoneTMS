...
Public Class DriverInfoRprt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMS_Payongayong.DriverInfoRprt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDriverInfoRprt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DriverInfoRprt = New DriverInfoRprt()
        rpt.Site = Me.Site
        Return rpt
    End Function
