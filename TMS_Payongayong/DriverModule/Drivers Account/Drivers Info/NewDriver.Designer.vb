...
Partial Class NewDriver
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtAssignedTaxi = New Telerik.WinControls.UI.RadTextBox()
    ...
    Friend WithEvents txtAssignedTaxi As Telerik.WinControls.UI.RadTextBox
