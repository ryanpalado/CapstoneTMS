...
Public Class TaxiInfoRprt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMS_Payongayong.TaxiInfoRprt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTaxiInfoRprt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaxiInfoRprt = New TaxiInfoRprt()
        rpt.Site = Me.Site
        Return rpt
    End Function
