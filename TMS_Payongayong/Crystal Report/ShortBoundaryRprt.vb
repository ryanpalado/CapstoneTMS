...
Public Class ShortBoundaryRprt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMS_Payongayong.ShortBoundaryRprt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShortBoundaryRprt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShortBoundaryRprt = New ShortBoundaryRprt()
        rpt.Site = Me.Site
        Return rpt
    End Function
