...
Public Class TaxiDamagesRprt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMS_Payongayong.TaxiDamagesRprt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTaxiDamagesRprt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TaxiDamagesRprt = New TaxiDamagesRprt()
        rpt.Site = Me.Site
        Return rpt
    End Function
