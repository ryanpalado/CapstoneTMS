...
Public Class CashAdvanceRprt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TMS_Payongayong.CashAdvanceRprt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashAdvanceRprt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashAdvanceRprt = New CashAdvanceRprt()
        rpt.Site = Me.Site
        Return rpt
    End Function
